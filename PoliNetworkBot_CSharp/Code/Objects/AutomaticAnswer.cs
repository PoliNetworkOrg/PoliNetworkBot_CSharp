...
public class AutomaticAnswer
{
    ...
    public AutomaticAnswer(List<List<string>> trigger,
        Func<MessageEventArgs, TelegramBotAbstract?, string, Task>? action, List<long> except,
        string response)
    {
        _trigger = trigger;
    ...
    public virtual bool TryTrigger(MessageEventArgs? e, TelegramBotAbstract? telegramBotAbstract,
        string message)
    {
...
public class AutomaticAnswerRestricted : AutomaticAnswer
{
    ...
    public override bool TryTrigger(MessageEventArgs? e, TelegramBotAbstract? telegramBotAbstract,
        string message)
    {
