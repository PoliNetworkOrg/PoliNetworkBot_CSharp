...
{
    private Func<MessageEventArgs, AbstractBot.TelegramBotAbstract?, Task>? _action;
    private Func<MessageEventArgs, AbstractBot.TelegramBotAbstract?, string, Task>? _actionMessage;
    ...
    public AutomaticAnswer(List<List<string>> trigger,
        Func<MessageEventArgs, AbstractBot.TelegramBotAbstract?, Task>? action,
        List<long> except)
    {
        _trigger = trigger;
        _action = action;
    ...
    public AutomaticAnswer(List<List<string>> trigger,
        Func<MessageEventArgs, AbstractBot.TelegramBotAbstract?, string, Task>? action, List<long> except,
        string response)
    {
        _trigger = trigger;
    ...
    public virtual bool TryTrigger(MessageEventArgs? e, AbstractBot.TelegramBotAbstract? telegramBotAbstract,
        string message)
    {
...
public class AutomaticAnswerRestricted : AutomaticAnswer
{
    ...
    public AutomaticAnswerRestricted(List<List<string>> trigger,
        Func<MessageEventArgs, AbstractBot.TelegramBotAbstract?, Task>? action, List<long> except,
    ...
    public override bool TryTrigger(MessageEventArgs? e, AbstractBot.TelegramBotAbstract? telegramBotAbstract,
        string message)
    {
