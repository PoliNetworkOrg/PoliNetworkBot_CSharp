...
public class TelegramFileContent
{
    ...
    public List<MessageSentResult>? SendToOwners(SampleNuGet.Objects.TelegramBotAbstract sender, string? langCode,
    ...
    private List<MessageSentResult>? SendToOwnersEmpty(EventArgsContainer? eventArgsContainer,
        SampleNuGet.Objects.TelegramBotAbstract sender, string? langCode, long? replyToMessageId2,
    ...
    private List<MessageSentResult>? SendToOwners2(EventArgsContainer? eventArgsContainer,
        SampleNuGet.Objects.TelegramBotAbstract sender, long? replyToMessageId2, FileTypeJsonEnum whatWeWant,
        string? langCode,
        LogFileInfo logFileInfo)
    {
        try
    ...
    public void SendToOwners3(EventArgsContainer? eventArgsContainer, SampleNuGet.Objects.TelegramBotAbstract sender,
