...
public class TargetUserObject
{
    ...
    public TargetUserObject(IReadOnlyList<string?>? stringInfo, AbstractBot.TelegramBotAbstract? sender,
    ...
    public async Task<bool> UserIdEmpty(AbstractBot.TelegramBotAbstract? telegramBotAbstract)
    {
    ...
    private async Task TryGetUserId(AbstractBot.TelegramBotAbstract? telegramBotAbstract)
    {
        if (_userId != null)
            return;
    ...
    public async Task<TargetUserObject> GetTargetUserId(AbstractBot.TelegramBotAbstract? telegramBotAbstract)
    {
