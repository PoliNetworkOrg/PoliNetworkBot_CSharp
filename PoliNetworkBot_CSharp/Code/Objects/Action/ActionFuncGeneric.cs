...
{
    private readonly Func<MessageEventArgs, TelegramBotAbstract?, string[]?,
        Task<CommandExecutionState>>? _action;

    private readonly Func<MessageEventArgs, TelegramBotAbstract?, string[]?, CommandExecutionState>?
        _action2;

    private readonly Func<MessageEventArgs, TelegramBotAbstract?, CommandExecutionState>? _action3;

    private readonly Func<MessageEventArgs, TelegramBotAbstract?, Task<CommandExecutionState>>?
        _action4;

    private readonly Func<MessageEventArgs, TelegramBotAbstract, string[]?, Task>? _action5;
    private readonly Func<MessageEventArgs?, TelegramBotAbstract?, Task>? _action6;
    ...
    public ActionFuncGeneric(Func<MessageEventArgs, TelegramBotAbstract, string[]?, Task>? action)
    {
        _action5 = action;
    }

    public ActionFuncGeneric(Func<MessageEventArgs?, TelegramBotAbstract?, Task>? action)
    {
        _action6 = action;
    }
