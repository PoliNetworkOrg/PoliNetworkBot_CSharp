...
namespace Minista.Helpers
{
    ...
    {
        public static void ShakeView(FrameworkElement view, float x = 2, bool vibrate = false)
        {
        ...
        public static readonly DependencyProperty IsVisibleProperty =
            DependencyProperty.RegisterAttached("IsVisible", typeof(bool), typeof(UIElement),
        ...
        private static void OnVisibleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue == oldValue || sender.Visibility == Visibility.Collapsed && !newValue) return;
        ...
        public static readonly DependencyProperty IsScaleEnabledProperty =
            DependencyProperty.RegisterAttached("IsScaleEnabled", typeof(bool), typeof(UIElement),
