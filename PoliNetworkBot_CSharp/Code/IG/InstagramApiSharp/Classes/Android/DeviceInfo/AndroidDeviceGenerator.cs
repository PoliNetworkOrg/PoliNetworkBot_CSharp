...
namespace InstagramApiSharp.Classes.Android.DeviceInfo
{
    ...
    {
        private static readonly List<string> DevicesNames = new()
        {
        ...
        public static AndroidDevice GetRandomAndroidDevice()
        {
            ...
            try
            {
                device.IGBandwidthTotalBytesB =
                    ((int)(double.Parse(device.IGBandwidthSpeedKbps) * double.Parse(device.IGBandwidthTotalTimeMS) +
