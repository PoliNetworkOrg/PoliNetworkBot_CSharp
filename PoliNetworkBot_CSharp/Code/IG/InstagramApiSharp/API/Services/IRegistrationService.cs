...
public interface IRegistrationService
{
    ...
    Task<IResult<InstaSignupConsentConfig>> GetSignupConsentConfigAsync(bool isMainAccount = false,
    ...
    Task<IResult<InstaRegistrationConfirmationCode>> CheckRegistrationConfirmationCodeAsync(string email,
    ...
    /// </param>
    Task<IResult<InstaRegistrationSuggestionResponse>>
        GetUsernameSuggestionsAsync(string name, string email = null);
    ...
    Task<IResult<bool>> GetOnboardingStepsAsync(InstaOnboardingProgressState progressState,
    ...
    Task<IResult<InstaPhoneNumberRegistration>> VerifySignUpSmsCodeAsync(string phoneNumber,
        string verificationCode);
