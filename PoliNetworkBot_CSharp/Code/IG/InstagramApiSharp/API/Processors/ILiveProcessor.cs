...
namespace InstagramApiSharp.API.Processors
{
    ...
    public interface ILiveProcessor
    {
        ...
        Task<IResult<InstaBroadcastCreate>> CreateAsync(int previewWidth = 720, int previewHeight = 1184,
        ...
        Task<IResult<InstaBroadcastCommentList>> GetCommentsAsync(string broadcastId, string lastCommentTs = "",
        ...
        Task<IResult<bool>> ShareLiveToDirectThreadAsync(string text, string broadcastId, string[] threadIds,
            string[] recipients);
