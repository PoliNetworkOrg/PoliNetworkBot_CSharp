...
internal class UserProcessor : IUserProcessor
{
    ...
    public async Task<IResult<InstaBlockedUsers>> GetBlockedUsersAsync(PaginationParameters paginationParameters)
    {
        ...
        try
        {
            ...
            static InstaBlockedUsers Convert(InstaBlockedUsersResponse instaBlockedUsers)
            {
                return ConvertersFabric.GetBlockedUsersConverter(instaBlockedUsers).Convert();
            }
    ...
    public async Task<IResult<InstaStoryFriendshipStatus>> GetFriendshipStatusAsync(long userId)
    {
        ...
        try
        {
            ...
            var converter = ConvertersFabric.GetStoryFriendshipStatusConverter(friendshipStatusResponse);
            return Result.Success(converter.Convert());
        }
        catch (HttpRequestException httpException)
        {
    ...
    public async Task<IResult<InstaFriendshipShortStatusList>> GetFriendshipStatusesAsync(params long[] userIds)
    {
        ...
        try
        {
            ...
            var converter =
                ConvertersFabric.GetFriendshipShortStatusListConverter(friendshipStatusesResponse);
    ...
    public async Task<IResult<InstaFullUserInfo>> GetFullUserInfoAsync(long userId)
    {
        try
        {
            ...
            var converter = ConvertersFabric.GetFullUserInfoConverter(fullUserInfoResponse);
            return Result.Success(converter.Convert());
        }
        catch (HttpRequestException httpException)
        {
    ...
    public async Task<IResult<InstaSuggestionItemList>> GetSuggestionDetailsAsync(params long[] userIds)
    {
        ...
        try
        {
            ...
            return Result.Success(ConvertersFabric.GetSuggestionItemListConverter(obj).Convert());
        }
        catch (HttpRequestException httpException)
        {
            _logger?.LogException(httpException);
    ...
    public async Task<IResult<InstaSuggestions>> GetSuggestionUsersAsync(PaginationParameters paginationParameters)
    {
        ...
        try
        {
            ...
            static InstaSuggestions Convert(InstaSuggestionUserContainerResponse suggestResponse)
            {
                   ...
                   && paginationParameters.PagesLoaded < paginationParameters.MaximumPagesToLoad)
            {
                ...
                suggestionsResponse.Value.NewSuggestedUsers.Suggestions.AddRange(moreSuggestions.Value
                    .NewSuggestedUsers.Suggestions);
                suggestionsResponse.Value.SuggestedUsers.Suggestions.AddRange(moreSuggestions.Value.SuggestedUsers
                    .Suggestions);
    ...
    public async Task<IResult<InstaUser>> GetUserAsync(string username)
    {
        ...
        try
        {
            ...
            var user = userInfo.Users?.FirstOrDefault(u =>
                u.UserName.ToLower() == username.ToLower().Replace("@", ""));
            if (user == null)
            {
    ...
    public async Task<IResult<InstaUser>> GetUserFromNametagAsync(InstaImage nametagImage)
    {
        ...
        try
        {
            ...
            {
                {
                    new StringContent(InstaApiConstants.IG_SIGNATURE_KEY_VERSION),
            ...
            var converter = ConvertersFabric.GetUserConverter(obj.User);
            return Result.Success(converter.Convert());
        }
        catch (HttpRequestException httpException)
        {
        ...
        PaginationParameters paginationParameters, string searchQuery, bool mutualsfirst = false)
    {
        try
        {
            ...
            if (user.Value.FriendshipStatus.IsPrivate && user.Value.UserName != _user.LoggedInUser.UserName &&
        ...
        PaginationParameters paginationParameters)
    {
        ...
        try
        {
            ...
            static IEnumerable<InstaMedia> Convert(InstaMediaListResponse mediaListResponse)
            {
                return mediaListResponse.Medias.Select(ConvertersFabric.GetSingleMediaConverter)
                    .Select(converter => converter.Convert());
            }
    ...
    public async Task<IResult<InstaFriendshipFullStatus>> IgnoreFriendshipRequestAsync(long userId)
    {
        ...
        try
        {
            ...
            var converter =
                ConvertersFabric.GetFriendshipFullStatusConverter(friendshipStatus.FriendshipStatus);
            return Result.Success(converter.Convert());
        }
        catch (HttpRequestException httpException)
        {
    ...
    private async Task<IResult<InstaFriendshipShortStatusList>> AddBestFriends(long[] userIdsToAdd,
        ...
        PaginationParameters paginationParameters)
    {
        ...
        {
            _logger?.LogException(httpException);
            return Result.Fail(httpException, default(InstaSuggestionUserContainerResponse),
    ...
    private async Task<IResult<InstaUserInfo>> GetUserInfoAsync(Uri userUri)
    {
        try
        {
            ...
            var converter = ConvertersFabric.GetUserInfoConverter(userInfo);
            return Result.Success(converter.Convert());
        }
        catch (HttpRequestException httpException)
        {
    ...
    private async Task<IResult<InstaStoryFriendshipStatus>> MuteUnMuteUserMedia(Uri instaUri, long userId,
        InstaMuteOption muteUnmuteOption)
    {
        ...
        try
        {
            ...
            var converter =
                ConvertersFabric.GetStoryFriendshipStatusConverter(friendshipStatus.FriendshipStatus);
