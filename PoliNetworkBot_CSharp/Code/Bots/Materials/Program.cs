...
public class Program
{
    ...
    private static async Task BotClient_OnMessageAsync2Async(object? sender, MessageEventArgs? e)
    {
        ...
        try
        {
...

            {
                try
                {
                    if (e?.Message != null && e != null && e.Message.Chat.Type != ChatType.Private) return;
                ...
                if (callbackQuery != null)
                {
                    ...
                    if (callbackdata != null)
                    {
                        ...
                        if (directory != null)
                        {
                            ...
                            var getGit = GetGit(directory);
                            if (getGit != null)
                            {
                                ModifiedFilesInGitFolder.TryGetValue(getGit, out var diffList);
                                ...
                                ModifiedFilesInGitFolder.Remove(getGit);
    ...
    {
        if (directory != null) return directory.Split(Convert.ToChar("/"), Convert.ToChar("\\")).GetValue(1);
        return null;
    }
        ...
        if (callbackQuery != null)
        {
            ...
            if (callbackdata != null)
            {
                ...
                if (s != null)
                {
                    ...
                    if (callbackQueryEventArgs.CallbackQuery != null && callbackQueryEventArgs.CallbackQuery.Message != null && !UserIsAdmin(sender, callbackQuery.From.Id, callbackQueryEventArgs.CallbackQuery.Message.Chat.Id))
                    {
                        if (sender != null)
    ...
    private static bool UserIsAdmin(TelegramBotAbstract? bot, long userId, long chatId)
    {
        try
        {
            ...
            if (result != null)
            {
                ...
                {
                    var ex1 = result.Result.GetFirstException();
                    if (ex1 !=null)
                        throw ex1;
                }
            }

            return result != null && result.Result != null && result != null && result.Result.IsSuccess();
        }
        catch (Exception? ex)
        {
    ...
    {
        if (e?.Message?.Text != null && e.Message != null && e != null && (e.Message.Text.Contains('/') || e.Message.Text.Contains('\\')))
        {
            GenerateStart(e);
            return;
        }
    ...
    {
        if (e?.Message?.From != null && e.Message != null && e != null && !UsersConversations.ContainsKey(e.Message.From.Id))
        {
                ...
                if (e.Message.From != null)
                {
                    ...
                    try
                    {
                        ...
                        if (replyKeyboard != null && replyKeyboard.Count == 0)
                            throw new Exception("No paths for folder " +
