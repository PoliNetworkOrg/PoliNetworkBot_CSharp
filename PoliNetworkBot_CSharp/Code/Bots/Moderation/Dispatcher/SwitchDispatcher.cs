...
public class SwitchDispatcher
{
    ...
    {
        new Command("start", Dispatcher.CommandDispatcher.HelpPrivate, new List<ChatType> { ChatType.Private },
            Permission.USER,
            new L("en", "Initialize bot", "it", "Inizializza il bot"), null, null),
        new Command("force_check_invite_links", Dispatcher.CommandDispatcher.ForceCheckInviteLinksAsync,
            ...
            null,
            null),
        new Command("contact", Dispatcher.CommandDispatcher.ContactUs, new List<ChatType> { ChatType.Private },
            Permission.USER,
            new L("en", "Show PoliNetwork contact's information", "it",
                "Mostra le informazioni per contattare PoliNetwork"), null, null),
        new Command("help", Dispatcher.CommandDispatcher.HelpPrivate, new List<ChatType> { ChatType.Private },
            Permission.USER,
        ...
        new Command("help_all", Dispatcher.CommandDispatcher.HelpExtended, new List<ChatType> { ChatType.Private },
            Permission.USER,
        ...
        new Command("ban", RestrictUser.BanUserAsync,
            ...
            new L("en", "Delete a message in chat. @condition: you need to reply to the message to delete", "it",
                "Cancella un messaggio in chat. @condition: devi rispondere al messaggio da cancellare"), null,
            e => e.Message.ReplyToMessage != null),
        new Command("test_spam", Dispatcher.CommandDispatcher.TestSpamAsync, new List<ChatType> { ChatType.Private },
            Permission.USER,
            ...
            e => e.Message.ReplyToMessage != null),
        new Command("groups", Dispatcher.CommandDispatcher.SendRecommendedGroupsAsync,
        ...
        new Command("allow_message", Dispatcher.CommandDispatcher.AllowMessageAsync,
            new List<ChatType> { ChatType.Private }, Permission.HEAD_ADMIN,
            new L("en", "allow a message"), null, null),
        new Command("allow_message_owner", Dispatcher.CommandDispatcher.AllowMessageOwnerAsync,
            new List<ChatType> { ChatType.Private },
            Permission.OWNER,
        ...
        new Command("rules", Dispatcher.CommandDispatcher.GetRules, new List<ChatType> { ChatType.Private },
            Permission.USER,
            new L("en", "get rules"), null, null),
        new Command("rooms", Dispatcher.CommandDispatcher.GetRooms, new List<ChatType> { ChatType.Private },
            Permission.USER,
