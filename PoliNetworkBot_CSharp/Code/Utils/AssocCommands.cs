...
public static class AssocCommands
{
    ...
    {
        _ = Assoc.Assoc_SendAsync(actionFuncGenericParams.TelegramBotAbstract, actionFuncGenericParams.MessageEventArgs)
            .Result;
    ...
    {
        _ = Assoc.Assoc_Publish(actionFuncGenericParams.TelegramBotAbstract, actionFuncGenericParams.MessageEventArgs)
            .Result;
        actionFuncGenericParams.CommandExecutionState = CommandExecutionState.SUCCESSFUL;
    }
    ...
    {
        _ = Assoc.Assoc_Read(actionFuncGenericParams.TelegramBotAbstract, actionFuncGenericParams.MessageEventArgs,
            false).Result;
        actionFuncGenericParams.CommandExecutionState = CommandExecutionState.SUCCESSFUL;
    }
    ...
    {
        _ = Assoc.Assoc_ReadAll(actionFuncGenericParams.TelegramBotAbstract, actionFuncGenericParams.MessageEventArgs)
            .Result;
        actionFuncGenericParams.CommandExecutionState = CommandExecutionState.SUCCESSFUL;
    }
    ...
    {
        _ = Assoc.Assoc_Delete(actionFuncGenericParams.TelegramBotAbstract, actionFuncGenericParams.MessageEventArgs)
            .Result;
        actionFuncGenericParams.CommandExecutionState = CommandExecutionState.SUCCESSFUL;
    }
}