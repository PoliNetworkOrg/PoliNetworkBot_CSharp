        ...
        internal static async Task<TelegramBotAbstract> ConnectAsync(BotInfoAbstract userbot)
        {
            switch (userbot.botTypeApi)
            {
                case Enums.BotTypeApi.REAL_BOT:
                    {
                        Telegram.Bot.TelegramBotClient telegramBotClient = new(userbot.token);
                        return new TelegramBotAbstract(telegramBotClient, userbot.website, userbot.contactString, userbot.botTypeApi.Value, userbot.onMessages);
                    }
                ...
                case Enums.BotTypeApi.USER_BOT:
                    {
                        ...
                        if (telegramClient.IsUserAuthorized())
                            return new TelegramBotAbstract(telegramClient, userbot.website, userbot.contactString, userbot.userId.Value, userbot.botTypeApi.Value, userbot.onMessages);
                ...
                case Enums.BotTypeApi.DISGUISED_BOT:
                    {
                        ...
                        if (t.IsUserAuthorized())
                            return new TelegramBotAbstract(t, userbot.website, userbot.contactString, userbot.userId.Value, userbot.botTypeApi.Value, userbot.onMessages);


                        var r = await t.AuthImportBotAuthorization(userbot.GetToken());

                        return r?.User != null ?       
                            new TelegramBotAbstract(t, userbot.website, userbot.contactString, userbot.userId.Value, userbot.botTypeApi.Value, userbot.onMessages)
                            : null;
                    }
